...
/*
    ...
    @Test
    public void mainTest2() throws Exception, AssertionError {
        File inputFile1 = createInputFile1();
        File inputFile2 = createInputFile2();
        ...
        //System.out.println("GET PATH!!!!" + inputFile1.getPath());
        ///Users/sadichha/Downloads/IndividualProject 3/replace/junit3296201230340291201.tmp.bck
        //Path testPrakash = Paths.get(inputFile1.getPath() + ".bck");
        //File f = new File(String.valueOf(Paths.get(inputFile1.getPath() + ".bck")));
        //boolean testing = f.exists();
        //boolean prakashexist = (Files.exists(testPrakash));
